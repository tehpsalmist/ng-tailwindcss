...
module.exports = (userDefConfig, defaultOverride) => {
  ...
  const defaultConfig = {
    configJS: `${path.normalize('./tailwind.config.js').replace(/\\/g, '\\\\')}`,
    sourceCSS: `${path.normalize('./src/tailwind.css').replace(/\\/g, '\\\\')}`,
    outputCSS: `${path.normalize('./src/styles.css').replace(/\\/g, '\\\\')}`,
    purge: false,
    sass: false,
